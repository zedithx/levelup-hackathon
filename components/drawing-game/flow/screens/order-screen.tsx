  ...
  return (
    <FlowShell stepLabel="ORDER">
      <div className="anim-fade-up">
        ...
        <p className="mt-2 text-sm leading-6 text-white/55">The phone follows this order. Current singer is highlighted during the round.</p>
      </div>
          ...
          <Panel className="flex items-center gap-3 p-3" key={turn.member.id}>
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-white/35">
                {turn.startSec}s - {turn.endSec}s ({turn.durationSec}s)
              </p>
            </div>
          </Panel>
        ))}
